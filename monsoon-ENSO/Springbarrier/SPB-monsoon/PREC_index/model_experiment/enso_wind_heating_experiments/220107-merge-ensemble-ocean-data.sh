...
#step1 : merge the cesm data into a whole data by using cdo
  ...
  if  [ ! -e  ${PRE_DIR_ORG}Ensemble_${i}/${modelname}.sst.0286-0287.nc ] ; then
    ...
    cdo_old  -select,name=${variable},level=500.0 ${modelname}.pop.h.0* ${modelname}.sst.0286-0287.nc
  fi
done 
fi
...
# step3 : ensemble mean 
cdo_old ensavg ${PRE_DIR_ORG}Ensemble_{1..30}/${modelname}.sst.0286-0287.nc  ${modelname}.sst.0286-0287_ensemblemean.nc 
#-----------------------------------------------------------
# fi

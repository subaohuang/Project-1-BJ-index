...
#     cdo  select,name=${variable} ${modelname}.cam.h0.* ${modelname}.cam.h1.0286-0287.nc
#   fi
# done 
# fi
...
cdo ensavg ${PRE_DIR_ORG}Ensemble_{11..20}/${modelname}.cam.h1.0286-0287.nc  ${modelname}.cam.h1.0286-0287_ensemblemean_1-10.nc 
#-----------------------------------------------------------
fi

...
# PRE_DIR_ORG=/home/ys17-19/lsh/CESM-data/F/F_2000_addindianwarming/
...
# step1 : merge the cesm data into a whole data by using cdo
  ...
  if  [ ! -e  ${PRE_DIR_ORG}${modelname}.cam.h0.0101-4012.nc ] ; then
    ...
    cdo select,name=U,V,OMEGA,PRECL,PRECC,PSL,PS ${modelname}.cam.h0.* ${modelname}.cam.h0.0101-4012.nc
  fi
...
# step3 calculate mass stream function
  ...
  if  [ ! -e /home/lsh/data/wc-result/msf_${modelname}_0101-4012.nc ] ; then

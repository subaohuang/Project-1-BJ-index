...
PRE_DIR_ORG=/home/ys17-19/lsh/CESM-data/F_1850-PDAY-rmallocean/
...
# step1 : merge the cesm data into a whole data by using cdo
  ...
  if  [ ! -e  ${PRE_DIR_ORG}F_1850-PDAY-rmallocean.cam.h0.197801-201212.nc ] ; then
    ...
    cdo select,name=U,V,OMEGA,PRECL,PRECC,PSL,PS F_1850-PDAY-rmallocean.cam.h0.* F_1850-PDAY-rmallocean.cam.h0.197801-201212.nc 
  fi
...
# step2 : interpolate the data from hybird level to pressure level
  if [ ! -e ${PRE_DIR_ORG}F_1850-PDAY-rmallocean.cam.h0.197801-201212_chazhi.nc ] ; then    ####判断差值的文件是否已经存在
    ...
    ncl  inpath='"~/lsh/CESM-data/F_1850-PDAY-rmallocean/F_1850-PDAY-rmallocean.cam.h0.197801-201212.nc"' \
         outpath='"~/lsh/CESM-data/F_1850-PDAY-rmallocean/F_1850-PDAY-rmallocean.cam.h0.197801-201212_chazhi.nc"' \
